...
expressions = [
 ...
 ,"renderGuitarConcept False AnnotateNote False True True standardTuning (sus4 $ dominant7thChord G) 4 2 False True [] False True"
 ...
 ,"renderGuitarConcept False AnnotateNote False True True standardTuning (minor7thChord A) 4 1 False False lightChord False True"
