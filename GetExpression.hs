...
expressions = [
 ...
 ,"renderGuitarConcept True AnnotatePositionVertical True True True standardTuning (minorChord C) 4 1 True False [] False"
 ...
 ,"renderGuitarConcept False AnnotateMarking False True True standardTuning (majorChord D) 4 0 False True [] False"
 ,"renderGuitarConcept False AnnotateMarking True True True standardTuning (fifthChord B) 4 0 False True powerChord True"
 ,"renderGuitarConcept False AnnotateNote False True True standardTuning (majorChord (flat A)) 4 0 False False [] False"
 ,"renderGuitarConcept False AnnotatePositionVertical False True True ukelele (majorChord C) 4 0 True False [] False"
 ,"renderGuitarConcept False AnnotateNote False True True standardTuning (majorScale B) 4 0 True False [] False"
 ,"renderGuitarConcept False AnnotateNote True True True standardTuning E 13 0 True False [] False"
